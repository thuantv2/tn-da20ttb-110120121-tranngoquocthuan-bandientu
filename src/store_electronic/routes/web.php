...
//payment
// Route::post('laravel/php/vnpay_payment','App\Http\Controllers\CheckoutController@vnpay_payment');
...
// Route::get('/vnpay_return', [CheckoutController::class, 'vnpay_return'])->name('vnpay_return');


Route::get('laravel/php/days-order','App\Http\Controllers\StatisticalController@days_order');

//AdminUsers
Route::post('laravel/php/save-user', 'App\Http\Controllers\UserController@save_user');
Route::get('laravel/php/all-users', 'App\Http\Controllers\UserController@all_users');
Route::get('laravel/php/edit-user/{user_id}', 'App\Http\Controllers\UserController@edit_user');
Route::post('laravel/php/update-user/{user_id}', 'App\Http\Controllers\UserController@update_user');
Route::get('laravel/php/delete-user/{user_id}', 'App\Http\Controllers\UserController@delete_user');

// AdminProfile
Route::post('laravel/php/save-admin', 'App\Http\Controllers\ProfileController@save_admin');
Route::get('laravel/php/all-admins', 'App\Http\Controllers\ProfileController@all_admins');
Route::get('/laravel/php/edit-admin/{admin_id}', 'App\Http\Controllers\ProfileController@edit_admin');
Route::post('/laravel/php/update-admin/{admin_id}', 'App\Http\Controllers\ProfileController@update_admin');
Route::get('/laravel/php/delete-admin/{admin_id}', 'App\Http\Controllers\ProfileController@delete_admin');

//loc
Route::get('/admin/statistics', [App\Http\Controllers\OrderController::class, 'getStatisticsData']);

// Route::post('laravel/php/filter-by-date','App\Http\Controllers\StatisticalController@filter_by_date');
Route::post('laravel/php/filter-best-selling-products','App\Http\Controllers\OrderController@filter_best_selling_products');

Route::post('laravel/php/filter-by-date1','App\Http\Controllers\OrderController@filter_by_date1');

Route::post('laravel/php/dashboard-filter','App\Http\Controllers\StatisticalController@dashboard_filter');
Route::get('laravel/php/days-order','App\Http\Controllers\StatisticalController@days_order');
