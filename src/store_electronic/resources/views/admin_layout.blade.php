...
<meta charset="UTF-8">
  ...
  <link href="{{ asset('BE/css/nucleo-svg.css') }}" rel="stylesheet" />
  <!-- CSS Files -->
  <link id="pagestyle" href="{{ asset('BE/css/soft-ui-dashboard.css') }}" rel="stylesheet" />
...
<body class="g-sidenav-show  bg-gray-100">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="{{ URL::to('/laravel/php/dashboard') }}">
        <img src="{{ asset('BE/img/logo-ct-dark.png') }}" class="navbar-brand-img h-100" alt="main_logo">
        <span class="ms-1 font-weight-bold">TM Dashboard</span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link  active" href="{{ URL::to('/laravel/php/dashboard') }}">
            <div
        ...
        <li class="nav-item">
          <a class="nav-link  " href="{{ URL::to('/laravel/php/all-category-product') }}">
            ...
            <a class="nav-link collapsed" href="{{ URL::to('/laravel/php/add-category-product') }}">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="{{ URL::to('/laravel/php/all-brand-product')}}">
            <div
              class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 43 36" version="1.1" xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <span class="nav-link-text ms-1">Thương hiệu sản phẩm</span>
        ...
        <li class="nav-item">
          <a class="nav-link  " href="{{ URL::to('laravel/php/list-coupon') }}">
            <div
              class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <span class="nav-link-text ms-1">Quản lý phiếu giảm giá</span>
            <a class="nav-link collapsed" href="{{ URL::to('/laravel/php/insert-coupon') }}">
                  <i class="fas fa-fw fa-cog"></i>
...
<!-- ------------- -->
        <li class="nav-item">
          <a class="nav-link  " href="{{ URL::to('/laravel/php/all-users') }}">
            <div class="fas fa-user icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>office</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <!-- <a class="nav-link collapsed" href="{{ URL::to('/laravel/php/add-user') }}">
                    <i class="fas fa-fw fa-cog"></i>
...
<!-- --------------->
<li class="nav-item">
          <a class="nav-link  " href="{{ URL::to('/laravel/php/all-admins') }}">
          <div
              class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1" >Hồ sơ Admin</span>
            <!-- <a class="nav-link collapsed" href="{{ URL::to('/laravel/php/add-admin') }}">
                    <i class="fas fa-fw fa-cog"></i>
