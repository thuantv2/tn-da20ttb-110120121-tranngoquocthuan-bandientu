...
<main class="main-content  mt-0 centered-form">
    ...
    <div class="card-header pb-0 text-left bg-transparent">
        <br>
        <br>
      <h3 class="font-weight-bolder text-info text-gradient">Thông tin cá nhân</h3>
    ...
    <div class="card-body">
      <form action="{{ URL::to('/laravel/php/update-user',$value->id) }}" method="post">
        ...
        <div class="mb-3">
            <label for="first_name">Tên người dùng: <span>*</span></label>
        ...
        <div class="text-center">
          <button type="submit" class="btn btn-success w-100 mt-4 mb-0">Lưu</button>
        </div>
