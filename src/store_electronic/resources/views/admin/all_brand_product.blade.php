...
<hr>
<h6 class="font-weight-bolder mb-0">Thương hiệu sản phẩm</h6>
    ...
    <tr>
      ...
      <td style="text-align: center;">
        <?php
          ...
          ?>
        <a href="{{ URL::to('laravel/php/active-brand-product/'.$br_pro->brand_id) }}"><span class="btn btn-success">Hiển thị</a>
          <?php
        }
        ?>
        ...
        if($br_pro-> brand_status ==0){
          ?>
        <a href="{{ URL::to('laravel/php/inactive-brand-product/'.$br_pro->brand_id) }}"><span class="btn btn-secondary">Không hiển thị</a>
          <?php
        }
        ?>
      ...
      <td style="text-align: center;">
      	<a href="{{URL::to('laravel/php/edit-brand-product/'.$br_pro->brand_id)}}" type="button" class="btn btn-info">Sửa</a>
