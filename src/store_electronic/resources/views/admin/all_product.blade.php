...
<table class="table align-middle mb-0 bg-white" >
  ...
  <tbody >
    ...
    <tr >
      ...
      <td style="text-align: center;">
        <img src="{{ asset('uploads/product/'.$pro->product_img) }}"  alt="" height="100px"  width="100px">   
      ...
      <td style="text-align: center;">
        <?php
          ...
          ?>
        <a href="{{ URL::to('laravel/php/active-product/'.$pro->product_id) }}"><span class="btn btn-success">Hiển thị</a>
          <?php
        }
        ?>
        ...
        if($pro-> product_status ==0){
          ?>
        <a href="{{ URL::to('laravel/php/inactive-product/'.$pro->product_id) }}"><span class="btn btn-secondary">Không hiển thị</a>
          <?php
        }
        ?>
      ...
      <td style="text-align: center;">
      	<a href="{{URL::to('laravel/php/edit-product/'.$pro->product_id)}}" type="button" class="btn btn-info">Sửa</a>
