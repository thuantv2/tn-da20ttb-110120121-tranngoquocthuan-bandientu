...
<hr>
<h6 class="font-weight-bolder mb-0">Danh mục sản phẩm</h6>
    ...
    <tr>
      ...
      <td style="text-align: center;">
        <?php
          ...
          ?>
        <a href="{{ URL::to('laravel/php/active-category-product/'.$cate_pro->category_id) }}"><span class="btn btn-success">Hiển thị</a>
          <?php
        }
        ?>
        ...
        if($cate_pro-> category_status ==0){
          ?>
        <a href="{{ URL::to('laravel/php/inactive-category-product/'.$cate_pro->category_id) }}"><span class="btn btn-secondary">Không hiển thị</a>
          <?php
        }
        ?>
      ...
      <td style="text-align: center;">
      	<a href="{{URL::to('laravel/php/edit-category-product/'.$cate_pro->category_id)}}" type="button" class="btn btn-info">Sửa</a>
