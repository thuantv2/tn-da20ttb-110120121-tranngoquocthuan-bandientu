...
<h6 class="font-weight-bolder mb-0">Sửa thương hiệu sản phẩm</h6>
...
<form style="width: 1500px;" action="{{ URL::to('/laravel/php/update-brand-product/'.$edit_value->brand_id) }}" method="post">
  ...
  <div class="form-group">
    <label style="font-size:16px" class="font-weight-bolder mb-0">Miêu tả thương hiệu</label>
  ...
  <hr>
  <button type="submit" name="update_brand_product" class="btn btn-primary">Lưu</button>
  <hr>
</form>
