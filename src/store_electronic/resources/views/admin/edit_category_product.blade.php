...
<h6 class="font-weight-bolder mb-0">Sửa danh mục sản phẩm</h6>
...
<form style="width: 1500px;" action="{{ URL::to('/laravel/php/update-category-product/'.$edit_value->category_id) }}" method="post">
  ...
  <div class="form-group">
    <label style="font-size:16px" class="font-weight-bolder mb-0">Miêu tả danh mục</label>
  ...
  <hr>
  <button type="submit" name="update_category_product" class="btn btn-primary">Lưu</button>
  <hr>
</form>
